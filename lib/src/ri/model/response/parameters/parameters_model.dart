...
class ParametersResponseModel extends IBaseModel<ParametersResponseModel> {
  ...
  List<OrderCancelModel>? cancelReasons;
  ...
  fromJson(Map<String, dynamic> json) {
    ...
    return ParametersResponseModel(
      ...
      cancelReasons: (json['cancel_reasons'] as List<dynamic>?)
...
class PaymentTagsModel {
  ...
  factory PaymentTagsModel.fromJson(Map<String, dynamic> json) => PaymentTagsModel(
        name: json["name"],
        code: json["code"],
      );
