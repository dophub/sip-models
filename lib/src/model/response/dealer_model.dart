...
class DealerModel extends IBaseModel<DealerModel> {
  ...
  fromJson(Map<dynamic, dynamic> json) => DealerModel(
    ...
    logoImage : json['logo_image'] != null ? ImagesModel.fromJson(json['logo_image']) : null,
    listImage : json['list_image'] != null ? ImagesModel.fromJson(json['list_image']) : null,
    mobileCoverImage : json['mobile_cover_image'] != null ? ImagesModel.fromJson(json['mobile_cover_image']) : null,
    latlng : json['latlng'],
